"""Finite certificate for S_12=4, m_3=13 on n_3=8S_12-1."""
...
EXPECTED_COUNTS = Counts(
    tail_rows=551649,
    eligible_tail_rows=528622,
    denominator_pairs=23844,
    shape_denominator_pairs=55559,
    digit_pairs=27092645100,
    coprime_pairs=10927072288,
    squarefree_pairs=3065318233,
    valuation_tail_pairs=5088309,
    modular_square_pairs=714489,
    nonnegative_discriminants=714489,
    square_discriminants=0,
)
EXPECTED_POSITIONS = Counter(
    {"b3-unique": 546900, "prefix-or-tie": 2792, "all-odd": 1957}
)
...
def main() -> None:
    ...
    check_digit_kernel()
    print("m_3=13 digit kernel and three size exclusions: OK")
    counts, positions = check_slice(M_3, D_3, SHAPES)
    assert positions == EXPECTED_POSITIONS
    assert counts == EXPECTED_COUNTS
    print(f"tail positions = {dict(positions)}")
    print(counts)
    print("DD 27.27 S=4, m_3=13 certificate: OK")
