...
REQUIRED_FILES = (
    ...
    ROOT / "pyproject.toml",
    ROOT / "uv.lock",
    ROOT / "scripts" / "check_dd_2710.py",
    ROOT / "scripts" / "check_dd_2711.py",
    ROOT / "scripts" / "check_dd_2712.py",
    ROOT / "scripts" / "check_dd_2713.py",
    ROOT / "scripts" / "check_dd_2714.py",
    ROOT / "scripts" / "check_dd_2715.py",
    ROOT / "scripts" / "check_dd_2716.py",
    ROOT / "scripts" / "check_dd_2717.py",
    ROOT / "scripts" / "check_dd_2718.py",
    ROOT / "scripts" / "check_dd_2719.py",
    ROOT / "scripts" / "check_dd_2720.py",
    ROOT / "scripts" / "check_dd_2721.py",
    ROOT / "scripts" / "check_dd_2722.py",
    ROOT / "scripts" / "check_dd_2723.py",
    ROOT / "scripts" / "check_dd_2724.py",
    ROOT / "scripts" / "check_dd_2725.py",
    ROOT / "scripts" / "check_dd_2726.py",
    ROOT / "scripts" / "check_dd_2727.py",
    ROOT / "scripts" / "check_dd_2728.py",
    ROOT / "scripts" / "check_dd_2729.py",
    ROOT / "scripts" / "check_dd_2729.cpp",
    ROOT / "scripts" / "check_dd_2730.cpp",
    ROOT / "scripts" / "check_dd_2731.cpp",
    ROOT / "scripts" / "check_dd_2732.cpp",
    ROOT / "scripts" / "check_dd_2733.cpp",
    PROOF_ROOT / "README.md",
    PROOF_ROOT / "problem-and-carrier.md",
    PROOF_ROOT / "global-framework.md",
    PROOF_ROOT / "branches" / "a2-only.md",
    PROOF_ROOT / "branches" / "double-deficit.md",
    PROOF_ROOT / "branches" / "a1-only.md",
...
SECTION_MARKERS = {
    ...
    PROOF_ROOT / "branches" / "a2-only.md": tuple(f"# {n}. " for n in range(12, 17)),
    PROOF_ROOT / "branches" / "double-deficit.md": tuple(
        f"# {n}. " for n in range(17, 28)
    ),
    PROOF_ROOT / "branches" / "a1-only.md": tuple(f"# {n}. " for n in range(28, 32)),
